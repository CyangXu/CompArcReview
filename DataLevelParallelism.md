...
- [Data-Level Parallelism](#data-level-parallelism)
  ...
  - [3. SIMD instruction set extensions for multimedia](#3-simd-instruction-set-extensions-for-multimedia)
  - [4. Graphics processing units](#4-graphics-processing-units)
  - [5 Detecting and enhancing loop-level parallelism](#5-detecting-and-enhancing-loop-level-parallelism)
